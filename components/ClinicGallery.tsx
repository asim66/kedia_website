...
export const clinicGalleryData: GalleryItem[] = [
  ...
  {
    id: "team-group",
    title: "Our Full Staff & Specialist Doctors",
    category: "consultation",
    description: "The complete Kedia Dental Care family — Dr. Shiv Dayal Kedia, specialist dental surgeons, and support staff.",
    image: "/images/clinic_team_seated.webp",
    badge: "22+ Years Strong",
    location: "Shuvam Towers",
  },
  {
    id: "lounge",
    ...
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-white via-purple-50/40 to-white border-t border-b border-purple-100/60">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 space-y-8 sm:space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 sm:space-y-4">
          <div className="inline-flex items-center px-3.5 py-1 rounded-full bg-purple-100 text-brand-primary text-xs sm:text-sm font-bold uppercase tracking-wider">
            Authentic Clinic Ambience
          </div>
